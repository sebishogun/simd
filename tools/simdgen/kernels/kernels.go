...
func binary(cName, goName string, t spec.Type, threshold int) spec.Kernel {
	return spec.Kernel{
...
func scaleK(cName, goName string, slice, scalar spec.Type, threshold int) spec.Kernel {
	return spec.Kernel{
		CName: cName, GoName: goName,
...
func axpy(cName, goName string, slice, scalar spec.Type, threshold int) spec.Kernel {
	return spec.Kernel{
		CName: cName, GoName: goName,
...
func reduce1(cName, goName string, slice, scalar spec.Type, threshold int) spec.Kernel {
	return spec.Kernel{
		CName: cName, GoName: goName,
...
func reduce2(cName, goName string, slice, scalar spec.Type, threshold int) spec.Kernel {
	return spec.Kernel{
		CName: cName, GoName: goName,
...
var Elementwise = []spec.Kernel{
	binary("simd_add_f32", "addFloat32", spec.SliceF32, 32),
	binary("simd_add_f64", "addFloat64", spec.SliceF64, 32),
	binary("simd_sub_f32", "subFloat32", spec.SliceF32, 32),
	binary("simd_sub_f64", "subFloat64", spec.SliceF64, 32),
	binary("simd_mul_f32", "mulFloat32", spec.SliceF32, 32),
	binary("simd_mul_f64", "mulFloat64", spec.SliceF64, 32),
	binary("simd_add_i32", "addInt32", spec.SliceI32, 32),
	binary("simd_add_i64", "addInt64", spec.SliceI64, 32),

	scaleK("simd_scale_f32", "scaleFloat32", spec.SliceF32, spec.F32, 32),
	scaleK("simd_scale_f64", "scaleFloat64", spec.SliceF64, spec.F64, 32),

	axpy("simd_addscaled_f32", "addScaledFloat32", spec.SliceF32, spec.F32, 32),
	axpy("simd_addscaled_f64", "addScaledFloat64", spec.SliceF64, spec.F64, 32),

	reduce1("simd_sum_f32", "sumFloat32", spec.SliceF32, spec.F32, 32),
	reduce1("simd_sum_f64", "sumFloat64", spec.SliceF64, spec.F64, 32),
	reduce2("simd_dot_f32", "dotFloat32", spec.SliceF32, spec.F32, 32),
	reduce2("simd_dot_f64", "dotFloat64", spec.SliceF64, spec.F64, 32),
}
