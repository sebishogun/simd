...
TEXT ·fastCumProdFloat64VSX(SB), NOSPLIT|NOFRAME, $0-48
	...
	MOVD a_base+24(FP), R4
	MOVD dst_len+8(FP), R5
	// The constants live in simdconst_fastCumProdFloat64VSX_pool<>(SB) and are reached through
	// R2. clang computed that from r12 and a TOC which does not
	// exist here, so its two global-entry instructions are nops.
	MOVD	$simdconst_fastCumProdFloat64VSX_pool<>(SB), R2
	// Constant pool appended below the body; the displacements
	// above were patched to reach it and the aligned loads made
	// unaligned, since nothing promises alignment inside a TEXT.
	WORD $0x60000000
...
DATA simdconst_fastCumProdFloat32VSX_pool<>+0x060(SB)/8, $0x000000003f800000
DATA simdconst_fastCumProdFloat32VSX_pool<>+0x068(SB)/8, $0x0000000000000000
DATA simdconst_fastCumProdFloat32VSX_pool<>+0x070(SB)/8, $0x000000003f800000
DATA simdconst_fastCumProdFloat32VSX_pool<>+0x078(SB)/8, $0x0000000000000000
DATA simdconst_fastCumProdFloat32VSX_pool<>+0x080(SB)/8, $0x3ff0000000000000
DATA simdconst_fastCumProdFloat32VSX_pool<>+0x088(SB)/8, $0x0000000000000000
DATA simdconst_fastCumProdFloat32VSX_pool<>+0x090(SB)/8, $0x0c0d0e0f1c1d1e1f
DATA simdconst_fastCumProdFloat32VSX_pool<>+0x098(SB)/8, $0x0405060708090a0b
DATA simdconst_fastCumProdFloat32VSX_pool<>+0x0a0(SB)/8, $0x00000000ffffffff
DATA simdconst_fastCumProdFloat32VSX_pool<>+0x0a8(SB)/8, $0x0000000000000000
GLOBL simdconst_fastCumProdFloat32VSX_pool<>(SB), RODATA|NOPTR, $176
...
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x000(SB)/8, $0x1c1d1e1f1c1d1e1f
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x008(SB)/8, $0x1415161718191a1b
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x010(SB)/8, $0x1c1d1e1f1c1d1e1f
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x018(SB)/8, $0x1415161718191a1b
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x020(SB)/8, $0x1c1d1e1f1c1d1e1f
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x028(SB)/8, $0x1415161718191a1b
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x030(SB)/8, $0x1c1d1e1f1c1d1e1f
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x038(SB)/8, $0x1415161718191a1b
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x040(SB)/8, $0x0c0d0e0f1c1d1e1f
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x048(SB)/8, $0x0405060708090a0b
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x050(SB)/8, $0x0c0d0e0f14151617
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x058(SB)/8, $0x0405060708090a0b
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x060(SB)/8, $0x000000003f800000
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x068(SB)/8, $0x0000000000000000
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x070(SB)/8, $0x000000003f800000
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x078(SB)/8, $0x0000000000000000
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x080(SB)/8, $0x3ff0000000000000
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x088(SB)/8, $0x0000000000000000
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x090(SB)/8, $0x0c0d0e0f1c1d1e1f
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x098(SB)/8, $0x0405060708090a0b
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x0a0(SB)/8, $0x00000000ffffffff
DATA simdconst_fastCumProdFloat64VSX_pool<>+0x0a8(SB)/8, $0x0000000000000000
GLOBL simdconst_fastCumProdFloat64VSX_pool<>(SB), RODATA|NOPTR, $176
...
DATA simdconst_cumProdInt32VSX_pool<>+0x060(SB)/8, $0x000000003f800000
DATA simdconst_cumProdInt32VSX_pool<>+0x068(SB)/8, $0x0000000000000000
DATA simdconst_cumProdInt32VSX_pool<>+0x070(SB)/8, $0x000000003f800000
DATA simdconst_cumProdInt32VSX_pool<>+0x078(SB)/8, $0x0000000000000000
DATA simdconst_cumProdInt32VSX_pool<>+0x080(SB)/8, $0x3ff0000000000000
DATA simdconst_cumProdInt32VSX_pool<>+0x088(SB)/8, $0x0000000000000000
DATA simdconst_cumProdInt32VSX_pool<>+0x090(SB)/8, $0x0c0d0e0f1c1d1e1f
DATA simdconst_cumProdInt32VSX_pool<>+0x098(SB)/8, $0x0405060708090a0b
DATA simdconst_cumProdInt32VSX_pool<>+0x0a0(SB)/8, $0x00000000ffffffff
DATA simdconst_cumProdInt32VSX_pool<>+0x0a8(SB)/8, $0x0000000000000000
GLOBL simdconst_cumProdInt32VSX_pool<>(SB), RODATA|NOPTR, $176
