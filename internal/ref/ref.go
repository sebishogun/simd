...
func setBase() kernel.Set {
	return kernel.Set{
		...
		Bytes: kernel.Bytes{
			...
			DtoaF64:        DtoaF64,
			LZ4BlockDecode: LZ4BlockDecode,
			RLEDecodeInt32: RLEDecodeInt32,
			RandFillU64:    RandFillU64,
			MergeSortedU32: MergeSortedU32,
			Interleave2U8:  Interleave2U8, Deinterleave2U8: Deinterleave2U8,
			Transpose8x8U8:   Transpose8x8U8,
			BitUnpackFastU32: BitUnpackFastU32,
			VarintDecodeU64:  VarintDecodeU64,
			BitshuffleU8:     BitshuffleU8,
			HashU64:          HashU64,
			...
			ParseInts: ParseInts, ParseUints: ParseUints, FormatInts: FormatInts,
