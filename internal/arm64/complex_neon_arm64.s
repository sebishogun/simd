...
TEXT ·csumComplex64NEON(SB), NOSPLIT|NOFRAME, $0-32
	MOVD $ret+24(FP), R0
	MOVD a_base+0(FP), R1
	MOVD a_len+8(FP), R2
	WORD $0x6f00e400
...
TEXT ·cdotComplex64NEON(SB), NOSPLIT|NOFRAME, $0-56
	MOVD $ret+48(FP), R0
	MOVD a_base+0(FP), R1
...
TEXT ·cdotconjComplex64NEON(SB), NOSPLIT|NOFRAME, $0-56
	MOVD $ret+48(FP), R0
	MOVD a_base+0(FP), R1
	MOVD b_base+24(FP), R2
	MOVD a_len+8(FP), R3
...
TEXT ·csumComplex128NEON(SB), NOSPLIT|NOFRAME, $0-40
	MOVD $ret+24(FP), R0
	MOVD a_base+0(FP), R1
	MOVD a_len+8(FP), R2
	WORD $0x6dbc3bef
...
TEXT ·cdotComplex128NEON(SB), NOSPLIT|NOFRAME, $0-64
	MOVD $ret+48(FP), R0
	MOVD a_base+0(FP), R1
	MOVD b_base+24(FP), R2
	MOVD a_len+8(FP), R3
...
TEXT ·cdotconjComplex128NEON(SB), NOSPLIT|NOFRAME, $0-64
	MOVD $ret+48(FP), R0
	MOVD a_base+0(FP), R1
	MOVD b_base+24(FP), R2
	MOVD a_len+8(FP), R3
